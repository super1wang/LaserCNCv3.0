...
C3a/b 的身份与文件键检查点之后，C3c1 已新增六项排序/历史身份回归，Debug 与定向 ASan 各 18/18，见 [C3c1 交付](docs/阶段交付/2026-09-04-ST1C3c1-排序与历史身份回归.md)。此前 C3b 全量 Debug 391/391 等成绩保留原范围；本轮未改生产代码，也不将局部次数相加冒充全量结果。下一步 C3c2 公开读取与恢复的水位锚点认证核验，C3 尚未闭合，整体仍未冻结。
