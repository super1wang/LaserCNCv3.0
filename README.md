...
LaserCNC v3.0 的 Application Kernel 已完成 Phase 1–9 与 K10A Execution Contract 1.0，当前按《Kernel 1.0 最终收口设计规划》继续推进 K10B–K10F。仓库坚持 Command-First、Automation-First、Headless-First 和 Infrastructure-Adapter；CAD、CAM、Machine、Process、Qt GUI、产品 RPC/CLI 与 AI 等上层模块仍未开始。
...
- Kernel 1.0 Closure：K10A Execution Contract 1.0 已验收，K10B Runtime Project/Document Lifecycle 待启动
- 标准：C++20
- 测试：Catch2 + CTest
