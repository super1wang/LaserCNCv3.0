...
当前收口按 [ST1C 补充执行计划](docs/内核契约/ST1C-补充审计与剩余执行计划.md) 继续：最新 [C6b6 观察状态与聚合准入](docs/阶段交付/2026-09-05-ST1C6b6-观察状态与聚合准入.md) 修复非法 Trace 终态、指标累计溢出、诊断未知状态及注册资源锁内释放。Debug/Release 选集各 181/181、ASan 同选集三次 543/543、探针另 3/3 和纯生产/源边界通过，不宣称普通全集 458 项。下一步按 [C6 子节点](docs/内核契约/ST1C6-公共契约与输入预算.md) 核实直接日志观察出口和日志等级，再完成其他公共契约、统一预算及终态保留，之后 C7/C8 与 ST1D。历史检查点只覆盖各自受测范围，整体尚未 Frozen，不扩展上层模块。
