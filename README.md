...
C3a 的自动关闭身份检查点之后，C3b 已完成显式 SnapshotId 与物理文件键解耦、身份信封、旧格式兼容及并发发布修复。最新 Debug 391/391、新增 13 项各 30 次、定向 ASan 34 项各 3 次、纯生产及架构检查通过，见 [C3b 交付](docs/阶段交付/2026-09-04-ST1C3b-显式快照文件键与兼容.md)。下一步 C3c 时间排序与历史身份域；新格式仅前向读取兼容，整体仍未冻结。
