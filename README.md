...
- Kernel 1.0 Closure：K10A–K10E 已验收；K10F 的 F1 软件故障注入已验收，F2A/F2B 已覆盖 Command/Transaction/History、实际 Task/Workflow 与 External Effect 三进程崩溃验证；Asset 崩溃与 F3–F5 待闭合，不能宣布 Kernel Frozen
- 标准：C++20
- 测试：Catch2 + CTest
