...
C2b3 本地检查点通过：独立于业务 Revision 的目录版本快照已实现，最终 Debug 360/360、专项 13/13、13 项各 10 次和纯生产/架构通过，见 [C2b3 交付](../阶段交付/2026-09-04-ST1C2b3-目录版本与失效.md)。真实同库三进程 epoch 更换已验证；仅对同一 Runtime/作用域的完整令牌比较失效，不赋予执行或跨目录原子写权限。当前下一步 C2c，C3/C4/C6–C8 和最终 ST1D 仍未签核。
