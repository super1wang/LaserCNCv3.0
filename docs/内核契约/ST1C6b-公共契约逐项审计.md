...
1. C6b2–b8 检查点保留；C6b9 修复 Trace 完成/abandoned 分配失败孤儿并明确尽力记录，见 [交付](../阶段交付/2026-09-05-ST1C6b9-Trace完成资源失败原子性.md)。下一步 Diagnostics latest 并发时间顺序，然后补 Host/执行/状态/持久族 DTO 与格式；不以 Trace 局部修复代签其他入口。
